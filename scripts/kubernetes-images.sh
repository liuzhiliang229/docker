...
#M.Liu
From_Ali(){
    echo -e "\033[1;34mkubernetes Version 1.21.2\033[0m"
    ...
    do
        ...
        docker tag $registry_url:kube-apiserver-v1.21.2 k8s.gcr.io/kube-apiserver:v1.17.4
        docker tag $registry_url:kube-controller-manager-v1.21.2 k8s.gcr.io/kube-controller-manager:v1.17.4
        docker tag $registry_url:coredns-1.6.5 k8s.gcr.io/coredns:1.6.5
        docker tag $registry_url:etcd-3.4.3-0 k8s.gcr.io/etcd:3.4.3-0
        docker tag $registry_url:pause-3.1 k8s.gcr.io/pause:3.1
        docker tag $registry_url:kube-proxy-v1.21.2 k8s.gcr.io/kube-proxy:v1.17.4
        docker tag $registry_url:kube-scheduler-v1.21.2 k8s.gcr.io/kube-scheduler:v1.17.4
...
From_Class(){
    ...
    10.30.5.120/docker/k8s.gcr.io/kube-controller-manager:v1.21.2
    10.30.5.120/docker/k8s.gcr.io/kube-scheduler:v1.21.2
    10.30.5.120/docker/k8s.gcr.io/kube-proxy:v1.21.2
    10.30.5.120/docker/k8s.gcr.io/kube-apiserver:v1.21.2
    )
